...
describe('Runnable Helpers', () => {
  ...
  describe('Log Event Helpers', () => {
    ...
    describe('warning', () => {
      ...
      it('should include additional metadata', () => {
        const event = warning('Deprecated API used', { api: 'oldMethod', version: '1.0' });
    ...
    describe('error', () => {
      ...
      it('should handle non-Error objects as errorData', () => {
        const event = error('Custom error', { code: 500, details: 'Server error' });
      ...
      it('should include additional metadata', () => {
        ...
        const event = error('Failed operation', testError, { operation: 'save', userId: 123 });
  ...
  describe('Performance Helpers', () => {
    describe('performance', () => {
      ...
      it('should include additional metadata', () => {
        const event = performanceHelper('API Call', 200, { endpoint: '/users', method: 'GET' });
    ...
    describe('PerformanceTimer', () => {
      ...
      it('should throw error when capturing without starting', () => {
        ...
        expect(() => timer.capture()).toThrow('Timer must be started before capturing measurements');
      });
    ...
    describe('measureAsync', () => {
      ...
      it('should measure async function execution', async () => {
        ...
        const { result, event } = await measureAsync('Async Operation', asyncFn);
      ...
      it('should handle async function errors', async () => {
        ...
        await expect(measureAsync('Failing Operation', asyncFn))
    ...
    describe('measure', () => {
      ...
      it('should handle synchronous function errors', () => {
        ...
        expect(() => measure('Failing Sync Operation', syncFn))
          .toThrow('Failing Sync Operation failed after 50ms: Sync error');
      });
    });
  });
});
...
describe('Integration Examples', () => {
  it('should demonstrate typical usage patterns', async () => {
    ...
    async function* exampleRunnable() {
      ...
      try {
        const { result, event } = await measureAsync('Database Save', async () => {

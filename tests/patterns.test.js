...
import { MapRunnable, FilterRunnable, ConditionalRunnable, ParallelJoinRunnable } from '../patterns.js';
...
describe('Reusable pattern runnables', () => {
  ...
  it('ConditionalRunnable should choose between runnables', async () => {
    class A extends Runnable { async *invoke() { return 'A'; } }
    class B extends Runnable { async *invoke() { return 'B'; } }
  ...
  it('ParallelJoinRunnable should run runnables and combine outputs', async () => {
    class PlusOne extends Runnable { async *invoke(i) { return i + 1; } }
    class TimesTwo extends Runnable { async *invoke(i) { return i * 2; } }
